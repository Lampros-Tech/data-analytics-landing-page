...
const CaseStudyMain = () => {
  return (
    <div className="relative bg-[#101010] min-h-screen">
      <Header />
      <div className="ml-10 mr-14 3xl:max-w-[1600px] 3xl:mx-auto pt-[130px] pb-16">
        <div className="relative border border-[#575757] py-8 px-10 rounded-2xl mb-10">
        ...
        <Typography variant="body1" className="mb-5 font-raleway font-[600]">
        ...
        <h1 className="text-[#7DDEDA] font-[400] text-[34px] font-leaguespartan mt-16">
...
<div key={index} className="flex items-center gap-2 ">
  ...
  <p className="text-white font-raleway text-[18px] font-[300]">{item.chain}</p>
        ...
        <h1 className="text-[#7DDEDA] font-[400] text-[34px] font-leaguespartan mt-20">
        ...
        <p className="font-[500] text-[28px] font-raleway text-white mt-16">
        ...
        <h3 className="text-white font-[500] text-[28px] font-raleway mt-14">
        ...
        <p className="font-[500] text-[28px] font-raleway text-white mt-10">
          Behavioral shift in asset transfers
        </p>
        <div className="text-white font-raleway flex gap-4 mt-6">
          <div className="bg-[#002523] rounded-xl py-6 pl-8 pr-12 max-w-[580px] min-w-[570px] font-[400] text-[20px]">
        ...
        <div className="text-white font-raleway flex gap-4 mt-6">
          <div className="bg-[#002523] rounded-xl py-4 pl-8 pr-12 max-w-[580px] min-w-[580px] font-[400] text-[20px]">
        ...
        <p className="font-[400] text-[20px] font-raleway text-white mt-6">
        ...
        <h1 className="text-[#7DDEDA] font-[400] text-[34px] font-leaguespartan mt-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 w-fit mt-10">
          {gainValue.map((item, index) => (
            <div
              key={index}
              className="bg-[#1A1A1A] gap-8 text-white rounded-2xl font-raleway font-[400] text-[20px] max-w-[550px] min-w-[530px] p-8 flex items-center "
            >
