...
const Works = () => {
  return (
    <div>
      <div className="rounded-xl bg-[#00695F] py-10 px-16 mx-4 3xl:max-w-[1600px] 3xl:mx-auto flex">
        <div className="flex-1">
          <Typography variant="h2" color="white" className={`max-w-xl font-leaguespartan`}>
            How We Deliver Web3 Data Analytics That Actually Work
          </Typography>
        </div>
        <div className="flex-1 flex flex-col justify-between pb-4">
          <Typography variant="h7" color="white" className={`max-w-xl font-leaguespartan`}>
            A proven pipeline built for precision, performance, and scale
          </Typography>
          <Typography variant="body1" color="white" className={`max-w-xl font-raleway`}>
