...
const WorksCard = ({ icon: Icon, title }: worksProps) => {
    return (
        <div className="flex items-center gap-6 bg-[#151515] rounded-2xl px-6 py-8 border hover:border-[#8CFFFD]/30 transition-colors 
    duration-300">
            <div className="p-4 bg-[#7DDEDA] text-black rounded-full">
                <Icon size={28} />
            </div>
        ...
        <>
            <div className='flex gap-2 mx-4'>
                <div className='flex-1/3 bg-[#00695F] rounded-2xl flex flex-col justify-between items-center py-10 relative'>
                    ...
                    <Image src={component} alt='why-it-works' width={350} height={350} className='absolute bottom-0 left-0 rounded-2xl' />
                </div>
            ...
            <div className='flex justify-between pt-16 pb-10 px-16 rounded-3xl bg-[#E4FFFE] mt-16 mx-4 xl:mx-28'>
