        ...
        <>
            <div className='flex gap-2 mx-4 3xl:max-w-[1600px] 3xl:mx-auto'>
                <div className='flex-1/3 bg-[#00695F] rounded-2xl flex flex-col justify-between items-center py-10 relative'>
                    <Typography variant="title" color="white" className={`font-leaguespartan z-10`}>
                        Why It <br /> Works
                    </Typography>
                    ...
                    <Image src={component} alt='why-it-works' width={350} height={350} className='absolute bottom-0 left-0 rounded-2xl object-cover' />
                </div>
            ...
            <div className='flex justify-between pt-16 pb-10 px-16 rounded-3xl bg-[#E4FFFE] mt-16 mx-4 3xl:max-w-[1600px] 3xl:mx-auto'>
                <div className='flex-1'>
                    <Typography variant='h2' color='secondary' className={`mb-6 max-w-[450px] font-leaguespartan`}>
